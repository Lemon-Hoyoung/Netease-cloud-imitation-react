...
import { UP_SPEED_LIST,
        ORIGIN_CREATE_LIST,
        NEW_SONG_LIST } from "../../store/constants";
...
export default memo(function HYRankingList() {
  ...
  // hooks
  useEffect(() => {
    dispatch(getTopData(UP_SPEED_LIST));
    dispatch(getTopData(NEW_SONG_LIST));
    dispatch(getTopData(ORIGIN_CREATE_LIST));
  }, [dispatch])
